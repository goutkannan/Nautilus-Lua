cmd_src/cxx/cxxglue.o := g++ -Wp,-MD,src/cxx/.cxxglue.o.d   -D__NAUTILUS__ -Iinclude  -include include/autoconf.h -D__NAUTILUS__ -O2 -fno-omit-frame-pointer -ffreestanding -fno-stack-protector -fno-strict-aliasing -fno-strict-overflow -mno-red-zone -mcmodel=large -fno-exceptions -fno-rtti     -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(cxxglue)"  -D"KBUILD_MODNAME=KBUILD_STR(cxxglue)" -c -o src/cxx/cxxglue.o src/cxx/cxxglue.cc

deps_src/cxx/cxxglue.o := \
  src/cxx/cxxglue.cc \
  include/autoconf.h \
...
src/cxx/cxxglue.o: $(deps_src/cxx/cxxglue.o)
