cmd_src/asm/lua_script.o := gcc -Wp,-MD,src/asm/.lua_script.o.d   -D__NAUTILUS__ -Iinclude  -include include/autoconf.h -D__NAUTILUS__  -m64    -c -o src/asm/lua_script.o src/asm/lua_script.S

deps_src/asm/lua_script.o := \
  src/asm/lua_script.S \
...
src/asm/lua_script.o: $(deps_src/asm/lua_script.o)
